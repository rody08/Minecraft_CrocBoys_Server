...
| AxGraves | Third-party | 1.29.0 | — | No | Installed |
| BetterStructures | Third-party | Unknown | — | No | Installed |
| BigOscieGF | Custom | 0.2.2 | `plugins/BigOscieGF/` | No | Running; Ollama verified at 1017 ms |
| BlueMap | Third-party | 5.23 | — | No | Installed |
| CannonRTP | Candidate custom | Unknown | Not imported | No | Installed |
| Chunky | Third-party | 1.5.3 | — | No | Installed |
| Citizens | Third-party | 2.0.43-b4246 | — | No | Installed |
| EliteMobs | Third-party | Unknown | — | No | Installed |
...
| floodgate | Third-party | Unknown | — | No | Installed |
| FreeMinecraftModels | Third-party | Unknown | — | No | Installed |
| Geyser-Spigot | Third-party | Unknown | — | No | Installed |
...
| ResourcePackManager | Third-party | Unknown | — | No | Installed |
